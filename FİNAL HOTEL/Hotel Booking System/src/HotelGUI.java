...
public class HotelGUI extends JFrame {
    ...
    public HotelGUI() {
        ...
        // windows
        setTitle("Kademi Hotel's Booking System");
        setSize(1200, 700);
    ...
    private JPanel licensePanel() {
        ...
        String licenseText = "Kademi Hotel's Booking System\n\n" +
                "Version: 2201\n" +
                "All rights reserved.\n\n" +
                "Credits: \nSu Elagöz for the main part of the code and helped the GUI.\n" +
                "Tuğberk Erdönmez for the GUI part of the code.";
